...
export default function Catalog() {
  return (
    <section id="catalogo" className="py-24 md:py-36 bg-dark text-cream relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center relative z-10">
        <ScrollReveal>
          <Lotus className="w-12 h-12 text-soft-gold mx-auto mb-8" />
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.2}>
          <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl text-cream leading-tight mb-6">
            Descubrí nuestra<br />colección completa
          </h2>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.4}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              href="https://wa.me/5491100000000?text=Hola%20ELUN%C3%88%2C%20me%20gustar%C3%ADa%20recibir%20el%20cat%C3%A1logo"
              target="_blank"
