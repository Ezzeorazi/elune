...
export default function NuevoProductoPage() {
  ...
  return (
    <div className="p-8 max-w-xl">
      ...
      <h1 className="text-3xl text-dark mb-7" style={serif}>
        Nuevo Producto
      </h1>

      <form onSubmit={submit} className="space-y-5">
        <div>
          <label className={lc} style={sans}>ID (slug único)</label>
          <input type="text" name="id" value={form.id} onChange={set} required placeholder="jabones-artesanales" className={ic} style={sans} />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="tag" value={form.tag} onChange={set} placeholder="Bestseller" className={ic} style={sans} />
          </div>
          <div>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-[11px] text-taupe/50" style={sans}>O pega la URL:</p>
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <input type="text" name="bg" value={form.bg} onChange={set} className={`${ic} flex-1`} placeholder="#f5f1eb" style={sans} />
          </div>
        </div>
